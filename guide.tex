...
\supervisor{村上 陽平 准教授}		% 指導教官名
\date{2020年2月1日}				% 提出年月日
...
ている。これらは永く教室に保管され，広く教官，学生の閲覧に供せられることになっ
ている。
...
なお，報告書および論文の作成に関して不明の点があれば，指導教官に相談されたい。

\acknowledgments				% 謝辞
...
　\includegraphics[width=14cm]{image.png}
  \caption{図を挿入する例}
\end{figure}
作成された図を\LaTeX に挿入するときには上記の例を参考いただければ
...
適用例が少ないこともあり，完璧なものとなっているとは断言できない。もし何か問
